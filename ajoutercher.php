...
VALUES ('$nmbrequipe','$nom','$prenom','$datedenaiss','$sex','$epouse','$diplome','$datediplome','$grade','$dategrade','$statut','$domaine','$structure','$email')";

$rsse=mysqli_query($con, $sql);
if($rsse){
  header("location:affihchage.php?numEquipe=$nmbrequipe");
}else{
