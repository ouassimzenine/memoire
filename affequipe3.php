...
<body>
<a href="acceuil3.php?numEquipe=<?php echo $numequipe ?>" style="margin-block-end: auto;    display: inline-block;
    padding: 10px 20pxpx;
    background: #fff;
    border-radius: 4px;
  ...
  font-size: 40px;
    ...
    while($row = mysqli_fetch_assoc($result)) { ?>
			<div class="box">
				...
				<div class="content">
                <a href="<?php echo 'affihchage3.php?responable=' . urlencode($numequipe) . '&numEquipe=' . urlencode($row['numero']); ?>">Plus</a>
