...
<head>
    ...
    <header>
    <a href="affequipe3.php?numEquipe=<?php $numEqp=$_GET['numEquipe']; echo $numEqp?>" style="margin-block-end: auto;    display: inline-block;
    padding: 10px 20pxpx;
    background: #fff;
    border-radius: 4px;
        ...
        <section class="table__body">
            <table>
                ...
                <tbody>
                    ...
                    $responsable=$_GET['responable'];
                  
                    if ($numEquipe == $responsable) {
                    ...
                    if ($result){
                        while($row=mysqli_fetch_assoc($result)){
                            ...
                            if ($numEquipe == $responsable) {
                                echo '<button><a href="'.$link2.'">Modifier</a></button> <br><br>';
                                echo '<button><a href="'.$link.'">Supprimer</a></button>';
                            }else{ echo 'none';}
